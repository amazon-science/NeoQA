...
from src.mglockne_story_line.questions.question_types.false_premise.contradictory_premise_reviser import \
    ContradictoryFalsePremiseReviser
from src.mglockne_story_line.questions.question_types.false_premise.uncertain_false_premise_reviser import \
    UncertainFalsePremiseReviser
from src.mglockne_story_line.questions.question_types.multi_hop_bridge.modules.multi_hop_bridge_question_distractor_module import \
...
from src.mglockne_story_line.questions.question_types.multi_hop_bridge.modules.multi_hop_bridge_question_write_module import \
    MultiEventMultiHopQuestionWriteModule
from src.mglockne_story_line.questions.question_types.multi_hop_bridge.modules.multi_hop_bridge_sentence_selection_module import \
...
def generate_multi_hop_bridge_questions(
    ...
    llm_name: str,
    event_num: int = 10,
    max_num_evidence_selections: int = 2,  # otherwise we generate way too much
...
def main():
    ...
    storyline_directories = [
            'outputs/storylines-final2/art_custom0_9/ART_art:custom0:9__A-comprehensive'
        ]
    generate_multi_hop_bridge_questions(
        storyline_directories,
        'claude-35',
        max_entities_per_selection=2,
        max_num_evidence_selections=1
    )
