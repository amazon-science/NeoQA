    ...
    def process(self, values: Dict) -> CritiqueResult:
        ...
        for parser in self.parsers:
            try:
                ...
                print("FOUND", result, parser.name, parser.locator)
        ...
        if len(parser_errors) == 0 and num_results >= self.min_number_results_total:
            ...
            if has_invalid_xml_error:
                err_message += '\nEnsure that special characters within the XML nodes (like "&") are properly escaped using UTF-8.'
