...
class Llama3BedrockHelper:
    ...
    def invoke_model(self, prompt, max_gen_len=512, temperature=0, top_p=0.9):
        accept = "application/json"
        contentType = "application/json"

        data = {"prompt": prompt,"max_gen_len":max_gen_len,"temperature":temperature,"top_p":top_p}
        ...
        try:
            ...
            Llama3BedrockHelper.__init__(self, self.model)
            response = self.bedrock_runtime.invoke_model(
                body=body, modelId=self.model, accept=accept, contentType=contentType
            )
