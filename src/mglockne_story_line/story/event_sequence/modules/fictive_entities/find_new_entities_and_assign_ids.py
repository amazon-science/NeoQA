...
from src.mglockne_story_line.story.event_sequence.modules.fictive_entities.entity_critiques.find_and_id_used_entities_critique import \
    FindUsedEntitiesCritique
from src.mglockne_story_line.util.entity_util import get_entity_categories, EntityIdProvider
