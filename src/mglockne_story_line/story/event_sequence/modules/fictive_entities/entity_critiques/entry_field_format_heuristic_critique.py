...
from src.mglockne_story_line.story.event_sequence.modules.fictive_entities.entity_name_heuristics import \
    has_forbidden_char, get_forbidden_char_critique_text_for, get_forbidden_chars
from src.mglockne_story_line.util.entity_util import get_location_fields
