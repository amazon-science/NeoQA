...
from src.mglockne_story_line.story.event_sequence.modules.fictive_entities.entity_critiques.ensure_all_entities_updated_critique import \
    EnsureAllEntitiesUpdatedCritique
from src.mglockne_story_line.util.entity_util import get_entity_categories, get_entity_fields, get_entity_by_id
