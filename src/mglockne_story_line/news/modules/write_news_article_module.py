...
class WriteNewsArticleModule(ParsableBaseModule):
    ...
    def _get_parsers(self) -> List[BasicNestedXMLParser]:
        return [
            BasicNestedXMLParser('headline', './/headline', is_object=False, to_single=True, result_node='result'),
            BasicNestedXMLParser('paragraphs', './/paragraph', is_object=True, to_single=False, result_node='result')
        ]
