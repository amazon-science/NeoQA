...
from experiments.parsing.multiple_choice_text_output_parser import MultipleChoiceTextOutputParser
...
class MultipleChoiceJsonOutputParser(OutputParser):

    def __init__(self, num_answer_options: int):
        self.num_answer_options: int = num_answer_options
        self.backup: MultipleChoiceTextOutputParser = MultipleChoiceTextOutputParser(num_answer_options)
