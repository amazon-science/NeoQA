...
def make_sentence_xml(sentence_id: str, outline_dict: Dict, use_key: str = 'decoded_sentence_full'):
...
def get_xml_event(event: Dict, outline_dict: Dict, use_key: str = 'decoded_sentence_full'):
...
def get_xml_event_selection(event: Dict, outline_ids: List[str], outline_dict: Dict, use_key: str = 'decoded_sentence_full'):
    outline_items: List[str] = []
...
def get_xml_for_events(
        all_events: List[Dict], outline_dict: Dict, cut_event_with_selection: Optional[List[Dict]] = None, use_key: str = 'decoded_sentence_full'
):
