...
from data_gen.timelines.event_sequence.modules.fictive_entities.entity_critiques.ensure_all_entities_filled_critique import \
    EnsureAllEntitiesFilledCritique
from data_gen.timelines.event_sequence.modules.fictive_entities.entity_critiques.entity_fill_format_miscalleneous_critique import \
    EntityFillFormatMiscellaneousCritique
from data_gen.timelines.event_sequence.modules.fictive_entities.entity_critiques.entry_field_format_heuristic_critique import \
...
from data_gen.util.entity_util import get_entity_categories, get_entity_category_from_id, get_entity_fields
...
class PopulateNewNamedEntitiesModule(ParsableBaseModule):
    ...
    def _create_formatting_critique(self, parsers: List[BasicNestedXMLParser]) -> Optional[BaseCritique]:
        # return ParsableRootNodeCritique(root_node='results', no_elaboration=True)
        return EntityFillFormatMiscellaneousCritique(root_node='results', no_elaboration=True)
