...
from data_gen.timelines.event_sequence.modules.fictive_entities.entity_critiques.avoid_problematic_entity_names_critique import \
    AvoidProblematicEntityNamesCritique
from data_gen.timelines.event_sequence.modules.fictive_entities.entity_critiques.entity_duplicate_found_name_critique import \
    NewEntityNameFoundTwiceCritique
from data_gen.timelines.event_sequence.modules.fictive_entities.entity_critiques.max_word_entity_name_critique import \
    MaxNameWordCountCritique
from data_gen.timelines.event_sequence.modules.fictive_entities.entity_critiques.new_entity_name_critique import \
...
class IdentifyNewNamedEntitiesModule(ParsableBaseModule):
    ...
    def _create_formatting_critique(self, parsers: List[BasicNestedXMLParser]) -> Optional[BaseCritique]:
        return ParsableRootNodeCritique('results', remove_node='scratchpad')
