...
from data_gen.timelines.event_sequence.modules.fictive_entities.entity_critiques.check_if_renaming_removed_another_entity_critique import \
    CheckIfRenamingRemovedAnotherEntityCritique
from data_gen.timelines.event_sequence.modules.fictive_entities.entity_critiques.entity_outline_fix_critique import \
...
class ResolveFoundNamedEntityConflictsInOutlineModule(ParsableBaseModule):
    ...
    def _create_critiques(self) -> List[BaseCritique]:
        return [
            HeuristicallyVerifyNamedEntitiesAreChangedCritique('avoid-old-names-in-outline'),
            CheckIfRenamingRemovedAnotherEntityCritique('avoid-renaming-good-entities', ignore_after=2)
        ]
